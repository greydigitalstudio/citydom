...
const Filter = (props) => {
  ...
  let layouts = props.filteredLayouts.filter(
  ...
  const rooms3 = rooms.filter(r => r === 3)
  const rooms4 = rooms.filter(r => r >= 4)
  ...
  function flatsRow() {
    ...
    for (let x = 0; x < house.porches.length; x++) {
      ...
      for (let i = 0; i < house.porches[porche].storeys.length; i++) {
        for (
          let j = 0;
          j < house.porches[porche].storeys[i].flats.length;
          j++
        ) {
          if (house.porches[porche].storeys[i].flats[j].price == "0") continue;
          flats[count] = {};
          flats[count].price = price1(
            house.porches[porche].storeys[i].flats[j].price
          );
          ...
          flats[count].spaceTotal =
            house.porches[porche].storeys[i].flats[j].spaceTotal + " м²";
          count++;
        }
      }
    }
    return (
      <div className={styles.content__flats_add}>
        {flats.map((flat, index) => {
          return (
            <div key={index} className={styles.content__flats_add_flat}>
  ...
  function setHouse({ target }) {
    ...
    target.parentNode.childNodes.forEach((item, i) => {
      ...
      if (id === item.id.split("-")[1])
        item.firstChild.className = styles.filter__button_primary;
      ...
      {mounted && (
        <MediaQuery minWidth={768}>
          ...
          {props.chess.map((house, index) => {
            let p = []
            const p1 =  house.porches.map((i) => i.storeys)
            p1.forEach(i => {
              i.forEach(j => {
                j.flats.forEach(k => {
                  p = p.concat(k.price)
          ...
          {props.section == "floats" ? (
            <div className={styles.filter__radio_row}>
              <RadioGroup
                ...
                change={setPorche}
                options={[
                  { value: "all", label: "Подъезд", v: true },
                  contains(porshes,porsh1) ? { value: '1', label: '1', v: true} : {v: false},
                  contains(porshes,porsh2) ? { value: '2', label: '2', v: true} : {v: false},
                  contains(porshes,porsh3) ? { value: '3', label: '3', v: true} : {v: false},
                  contains(porshes,porsh4) ? { value: '4', label: '4', v: true} : {v: false},
                  contains(porshes,porsh5) ? { value: '5', label: '5', v: true} : {v: false},
                ]}
              />
            </div>
          ) : (
          ...
          <div id="floor-radio" className={styles.filter__radio_row}>
            <RadioGroup
              ...
              options={[
                { value: 'all', label: 'Все', v: true},
                contains(rooms,rooms0) ? { value: '0', label: 'Студия', v: true} : {v: false},
                contains(rooms,rooms1) ? { value: '1', label: '1', v: true} : {v: false},
                contains(rooms,rooms2) ? { value: '2', label: '2', v: true} : {v: false},
                contains(rooms,rooms3) ? { value: '3', label: '3', v: true} : {v: false},
                contains(rooms,rooms4) ? { value: '4', label: '4+', v: true} : {v: false},
              ]}
            />
          </div>
        </MediaQuery>
        ...
        <MediaQuery maxWidth={767}>
          <Link href="/">
            <div className={styles.filter__background_back}>
              ...
              >
                ...
                <path
                  d="M10.4543 17.2929C10.0638 17.6834 10.0638 18.3166 10.4543 18.7071L16.8183 25.0711C17.2088 25.4616 17.842 25.4616 18.2325 25.0711C18.623 24.6805 18.623 24.0474 18.2325 23.6569L12.5756 18L18.2325 12.3431C18.623 11.9526 18.623 11.3195 18.2325 10.9289C17.842 10.5384 17.2088 10.5384 16.8183 10.9289L10.4543 17.2929ZM28.6614 17L11.1614 17V19L28.6614 19V17Z"
                  fill="white"
                />
                <defs>
                  <filter
                    id="filter0_b_133_2516"
                    x="-3.83859"
                    y="-4"
                    width="44"
                    height="44"
                  ...
                  >
                    ...
                    <feComposite
                      in2="SourceAlpha"
                      operator="in"
                      result="effect1_backgroundBlur_133_2516"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_backgroundBlur_133_2516"
                      result="shape"
                    />
                  </filter>
                </defs>
              ...
              <defs>
                ...
                >
                  ...
                  <feComposite
                    in2="SourceAlpha"
                    operator="in"
                    result="effect1_backgroundBlur_133_2515"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_backgroundBlur_133_2515"
                    result="shape"
                  />
                </filter>
              </defs>
          ...
          <div className={styles.filter__background_upload}>
            ...
            >
              ...
              <path
                d="M9.66138 21.0938V24.9687C9.66138 26.6256 11.0045 27.9687 12.6614 27.9687H24.1614C25.8182 27.9687 27.1614 26.6256 27.1614 24.9687V21.0938"
                stroke="white"
                strokeWidth="2"
                strokeLinecap="round"
              ...
              <defs>
                ...
                >
                  ...
                  <feComposite
                    in2="SourceAlpha"
                    operator="in"
                    result="effect1_backgroundBlur_133_2514"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_backgroundBlur_133_2514"
                    result="shape"
                  />
                </filter>
              </defs>
            ...
            {photos.map((item, index) => {
              return (
                <div
                  ...
                  key={index}
                  className={
                    styles.filter__photos_pagination_item +
                    (photoIndex == index
                      ? " " + styles.filter__photos_pagination_item_selected
                      : "")
                  }
                ></div>
              );
          ...
          <div className={styles.content__title}>
            ...
            <div className={styles.item__flatscount}>
              {data.flatsCount}{" "}
              {data.flatsCount % 100 < 20 && data.flatsCount % 100 > 10
                ? " квартир"
                : data.flatsCount % 10 === 1
                ? " квартира"
                : data.flatsCount % 10 < 5 && data.flatsCount % 10 > 0
                ? " квартиры"
                : " квартир"}
            </div>
          </div>
          <div className={styles.content__address}></div>
            ...
            {props.chess.map((house, index) => {
              return (
                ...
                >
                  ...
                  >
                    {house.title}{" "}
                    {house.endСonstruction ? house.endСonstruction : ""}
                  </div>
                </div>
              );
            })}
          ...
          {section === "floats" && (
            <div className={styles.content__flats}>
              {flats.map((row, index) => {
                return (
                  <div className={styles.content__flats_row} key={index}>
                    <div className={styles.content__flats_wrapper}>
                      ...
                      {row.flats.map((item, index) => {
                        return (
                          <div
                            className={styles.content__flats_item}
                            key={index}
                            id={"layout-19193"}
                            onClick={showModal}
                          >
          ...
          {section === "layouts" && (
            <div className={styles.content__layouts}>
              {layouts.map((item, index) => {
                return (
                  <div
                    className={styles.content__layout}
                    id={"layout-" + item.id}
                    key={index}
                    onClick={showModal}
                  >
                    <div className={styles.content__layout_wrapper}>
                      <div className={styles.content__layout_image}>
                        <img
                          src={"https://files.citidom.com/" + item.layout}
                          alt=""
                        />
                      </div>
            ...
            <>
              <div className={styles.content__modal}>
                <div className={styles.content__modal_image}>
                  <img
                    src={"https://files.citidom.com/" + modalLayout.layout}
                    alt=""
                  />
                </div>
                <div
                  className={styles.content__modal_close}
                  onClick={closeModal}
                >
                  <svg
                    width="16"
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feComposite
                          in2="SourceAlpha"
                          operator="in"
                          result="effect1_backgroundBlur_133_2698"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_backgroundBlur_133_2698"
                          result="shape"
                        />
                      </filter>
                    </defs>
                ...
                <div className={styles.content__modal_upload}>
                  ...
                  >
                    ...
                    <path
                      d="M10.08 21.0938V24.9687C10.08 26.6256 11.4231 27.9687 13.08 27.9687H24.58C26.2368 27.9687 27.58 26.6256 27.58 24.9687V21.0938"
                      stroke="white"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M19.5371 7.32414C19.1465 6.93362 18.5134 6.93362 18.1229 7.32414L11.7589 13.6881C11.3684 14.0786 11.3684 14.7118 11.7589 15.1023C12.1494 15.4928 12.7826 15.4928 13.1731 15.1023L18.83 9.44546L24.4868 15.1023C24.8773 15.4928 25.5105 15.4928 25.901 15.1023C26.2915 14.7118 26.2915 14.0786 25.901 13.6881L19.5371 7.32414ZM19.83 24.1563L19.83 8.03125L17.83 8.03125L17.83 24.1562L19.83 24.1563Z"
                      fill="white"
                    />
                    <defs>
                      <filter
                        id="filter0_b_133_2697"
                        x="-3.17004"
                        y="-4"
                        width="44"
                        height="44"
                      ...
                      >
                        ...
                        <feComposite
                          in2="SourceAlpha"
                          operator="in"
                          result="effect1_backgroundBlur_133_2697"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_backgroundBlur_133_2697"
                          result="shape"
                        />
                      </filter>
                    </defs>
                ...
                <div className={styles.content__modal_info}>
                  ...
                  <div className={styles.content__modal_text}>
                    {modalLayout.house.quarter}-квартал {modalLayout.house.year}{" "}
                    года.
                  </div>
